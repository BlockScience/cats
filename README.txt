...
This is a walk through on how to install dependencies for CATs on Ubuntu 20.04 LTS. I'm will provide links for variations
of Ubuntu / Linux.
...
Essentials: curl, apt-transport-https
```
sudo apt update -y
sudo apt upgrade -y
...
sudo echo 'export GIT_USR=<github username> >> ~/.profile
sudo echo 'export GIT_PSWD=<github password> >> ~/.profile
source ~/.profile
```

Execute CATs
sudo echo 'export CATS_HOME=$(pwd)' >> ~/.profile
Next Steps