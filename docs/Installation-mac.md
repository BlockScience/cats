# Installation: MacOS Monteray 12.3
...
* **Essentials:**
  ...
  sudo apt update
  sudo apt upgrade
  sudo brew install wget ca-certificates
...
* **[Docker:](https://www.digitalocean.com/community/tutorials/how-to-install-and-use-docker-on-ubuntu-20-04)**
  ...
  * **Executing the Docker Command Without Sudo:** Inspired by [this](https://docs.docker.com/engine/install/linux-postinstall/#manage-docker-as-a-non-root-user)
    ...
    ```
* [**Hypervisor, Minikube, & Kubectl:**](https://medium.com/@javatechie/kubernetes-tutorial-install-run-minikube-in-mac-os-k8s-cluster-369b25b0c3f0)
    ...
    * Install a Hypervisor
    ...
    ```
    * Install Minikube
      * Note: `minikube start` needs password
    ```bash
...
* **Prerequisites:**
  ...
  * Note: MAC & more Note - Python version toggles (pyenv or linux solution)
    * after `sudo make install --alt-install`
  ```bash
